...
exports.run = async(client, message, args) => {
        ...
        const gullu = new Discord.MessageEmbed()
             ...
             .addField(`>  **${prefix}nuke**`,`Nuke Yazarak Kanalı Silip Yeniden Oluşturmak İcindir`, true)
             .addField(`>  **${prefix}sil**`,`Chate Bir Miktar Yazarak Mesajları Silmek İcindir`, true)
             .addField(`>  **${prefix}snipe**`,`Silinen Mesajı Yazan Avatarını Ve Mesajı Göstermek İcindir`, true)
             .addField(`>  **${prefix}yavaşmod**`,`Kanala Saniyesini Yazarak Bir Miktar Yavaş-mod Koymak İcindir`, true)
