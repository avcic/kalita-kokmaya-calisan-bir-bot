...
module.exports.run = async (bot, message, args) => { 
  ...
  var embed2 = new Discord.MessageEmbed()   
      ...
      .setDescription('Sadece Sahibim Bu Komutu Kullanabilir! Yani GhostButDevil <@774591026940739585> ')
      .setColor('RED') 
  

  if(message.author.id !== "774591026940739585") return message.channel.send(embed2)
     
  //Cortex botun reboot sistemi hadi h.o
  var embed = new Discord.MessageEmbed()   
      .setTitle('**Merhaba Sahibim GhostButDevil,**')
