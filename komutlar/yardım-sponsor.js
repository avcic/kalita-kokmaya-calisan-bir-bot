...
exports.run = async(client, message, args) => {
        ...
        const gullu = new Discord.MessageEmbed()
             ...
             .addField(`>  **${prefix}cemdesing**`,`Tasarım Sponsorumuz Göstermek İcindir`, true)
             .addField(`>  **${prefix}gamedoping**`,`Vds Sponsorumuz Göstermek İcindir`, true)
             .addField(`Linkler`, `[Davet Et](https://discord.com/oauth2/authorize?client_id=784517399314432050&permissions=8&scope=bot) **|** [Oy Ver](https://top.gg/bot/784517399314432050/vote) **|** [Destek Sunucusu](https://discord.gg/RvPfmr6CCx) **|** [Sitesi](https://gullubot.ga/)`)
