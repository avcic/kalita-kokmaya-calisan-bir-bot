...
exports.run = async(client, message, args) => {
        ...
        const gullu = new Discord.MessageEmbed()
             ...
             .addField(`>  **${prefix}eval**`,`Botda Komut Denemek İcindir`, true)
             .addField(`>  **${prefix}exec**`,`Konsola Komut Atmak İcindir`, true)
             .addField(`>  **${prefix}bakım-modu**`,`Botu Bakım Moduna Almak İcindir`, true)
             .addField(`>  **${prefix}karaliste**`,`Bir Üyenin İdsini Alarak Karalisteye Almak İcindir`, true)
             .addField(`>  **${prefix}reboot**`,`Botu Yeniden Başlatmak İcindir`, true)
