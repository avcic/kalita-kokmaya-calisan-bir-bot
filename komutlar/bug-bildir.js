...
let channel = bot.channels.cache.get("843885064827830302")//bug repot kanal id
...
.setColor("RED")
  const embed2 = new Discord.MessageEmbed()
    .setColor("RED")
    .setDescription(
      `${message.author.username}, Hata Bildiriminiz Yetkililere İletilmiştir. Geri dönüş yapılmayacaktır.`)
